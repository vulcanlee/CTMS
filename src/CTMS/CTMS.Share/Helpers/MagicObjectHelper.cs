namespace CTMS.Share.Helpers
{
    public class MagicObjectHelper
    {
        ...
        public const string WhiteBloodCell白血球WBC = "白血球計數 WBC";
        public const string NeutrophilCount絕對嗜中性白血球數Seg = "嗜中性白血球 Seg";
        public const string NeutrophilCount帶狀性中性球Band = "帶狀性中性球 Band";
        public const string HemoglobinHb血色素Hb = "血色素 Hb";
        public const string PlateletCount血小板Plt = "血小板 Plt";
        ...
        #region 操作歷程
        public const string AOAILabKey = "dbaf7e23896741359559a996b45e686f";
        public const string AOAILabModelName = "gpt-5";
        public const string AOAILabEndPoint = "https://gpt4tw.openai.azure.com/";

        public const string Folder操作歷程 = "OperationContent";
        ...
        public const string OperationCategory上傳影像 = "上傳影像";
...
使用底下 json 結構回應，回應必須是合法 JSON(若不合法，回應沒改變)，不要多出任何註解或額外文字。不需要其他額外文字內容 
{ 
""Summary"": ""一句話的摘要"", 
""Detail"": ""一句話詳細說明資料異動狀況 ，可儲存為操作紀錄訊息"" ,
""IsChanged"": true
}";
