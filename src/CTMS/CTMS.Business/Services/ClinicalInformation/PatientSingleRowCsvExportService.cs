...
public class PatientSingleRowCsvExportService
{
    ...
    private static List<ColumnDef> BuildColumns(int max合併用藥)
    {
        var cols = new List<ColumnDef>
        {
            ...
            new("CancerType",             "癌症類型"),
            new("Age",                    "年齡"),
            new("MenstrualStatus",        "月經狀態"),
            new("Height",                 "身高(cm)"),
            new("Weight",                 "體重(kg)"),
            new("BMI",                    "BMI"),
            new("BSA",                    "體表面積(m²)"),
            new("AbdominalCircumference", "腰圍(cm)"),
            new("PerformanceStatus",      "日常體能狀態(PS)"),
            new("FIGOStaging",            "癌症分期(2023 FIGO)"),
            new("AJCCClinicalStage",      "AJCC c stage"),
            new("AJCCClinicalStageT",     "AJCC c stage T"),
            new("AJCCClinicalStageN",     "AJCC c stage N"),
            new("AJCCClinicalStageM",     "AJCC c stage M"),
            new("AJCCPathologicalStage",  "AJCC p stage"),
            new("AJCCPathologicalStageT", "AJCC p stage T"),
            new("AJCCPathologicalStageN", "AJCC p stage N"),
            new("AJCCPathologicalStageM", "AJCC p stage M"),
            new("HistologicalType",       "組織型態"),
            new("HistologicalTypeDetail", "組織型態細節"),
            new("MMRProtein",             "MMR protein"),
            new("P53",                    "p53"),
            new("HormonStatus",           "Hormon status"),
            new("HormonStatusER",         "Hormon status ER"),
            new("HormonStatusERPercent",  "Hormon status ER%"),
            new("HormonStatusPR",         "Hormon status PR"),
            new("HormonStatusPRPercent",  "Hormon status PR%"),
            // ── 風險評估 ────────────────────────────────────────────
