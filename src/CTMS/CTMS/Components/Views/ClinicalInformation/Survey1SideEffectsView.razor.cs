...
public partial class Survey1SideEffectsView
{
    [Parameter]
    ...
    bool editMode = false;
    Survey1SideEffects副作用Node data = new();
    Survey1SideEffects副作用 header = new();
    ...
    {
        header = patientData.臨床資料.SurveySideEffects副作用1;
        if (isFirst)
        {
