...
public partial class PatientAdapter : DataAdaptor<PatientService>
{
    ...
    public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
    {
        ...
        try
        {
            DataRequestResult<PatientAdapterModel> adaptorModelObjects = await Service.GetAsync(dataRequest);
        ...
        {
            return new DataResult() { Result = new List<PatientAdapterModel>(), Count = 0 };
        }
        #endregion
    }
}
