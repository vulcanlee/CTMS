...
public class RoleViewDetailViewModel
{
    #region Constructor
    public RoleViewDetailViewModel(RoleViewDetailService CurrentService,
    ...
    /// 現在正在新增或修改的紀錄  
    /// </summary>
    public RoleViewDetailAdapterModel CurrentRecord { get; set; } = new RoleViewDetailAdapterModel();
    /// <summary>
    /// 現在正在刪除的紀錄  
    /// </summary>
    public RoleViewDetailAdapterModel CurrentNeedDeleteRecord { get; set; } = new RoleViewDetailAdapterModel();
    /// <summary>
    /// 保存與資料編輯程式相關的中繼資料
    /// </summary>
    ...
    /// </summary>
    private readonly RoleViewDetailService CurrentService;
    ...
    public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
    {
        ...
        {
            CurrentRecord = new RoleViewDetailAdapterModel();
            #region 針對新增的紀錄所要做的初始值設定商業邏輯
            #endregion
            EditRecordDialogTitle = "新增紀錄";
            isNewRecordMode = true;
            IsShowEditRecord = true;
            CurrentRecord.RoleViewId = Header.Id;
    ...
    public async Task OnCommandClicked(CommandClickEventArgs<RoleViewDetailAdapterModel> args)
    {
        RoleViewDetailAdapterModel item = args.RowData as RoleViewDetailAdapterModel;
