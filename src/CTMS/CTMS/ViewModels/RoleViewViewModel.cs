...
{
    #region Constructor
    public RoleViewViewModel(RoleViewService CurrentService,
    ...
    /// 現在正在新增或修改的紀錄  
    /// </summary>
    public RoleViewAdapterModel CurrentRecord { get; set; } = new RoleViewAdapterModel();
    /// <summary>
    /// 現在正在刪除的紀錄  
    /// </summary>
    public RoleViewAdapterModel CurrentNeedDeleteRecord { get; set; } = new RoleViewAdapterModel();
    /// <summary>
    /// 保存與資料編輯程式相關的中繼資料
    /// </summary>
    ...
    /// </summary>
    private readonly RoleViewService CurrentService;
    ...
    public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
    {
        ...
        {
            CurrentRecord = new RoleViewAdapterModel();
    ...
    public async Task OnCommandClicked(CommandClickEventArgs<RoleViewAdapterModel> args)
    {
        RoleViewAdapterModel item = args.RowData as RoleViewAdapterModel;
        ...
        else if (args.CommandColumn.ButtonOption.IconCss == ButtonIdHelper.ButtonIdShowDetailOfMaster)
        {
            ...
            ShowMoreDetailsRecordDialogTitle = MagicObjectHelper.角色明細之專案清單管理功能名稱;
