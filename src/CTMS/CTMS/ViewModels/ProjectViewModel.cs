...
{
    #region Constructor
    public ProjectViewModel(ProjectService CurrentService,
    ...
    public ProjectAdapterModel CurrentRecord { get; set; } = new ProjectAdapterModel();
    public ProjectAdapterModel CurrentNeedDeleteRecord { get; set; } = new ProjectAdapterModel();
    ...
    private readonly ProjectService CurrentService;
    ...
    public async Task OnCommandClicked(CommandClickEventArgs<ProjectAdapterModel> args)
    {
        ProjectAdapterModel item = args.RowData as ProjectAdapterModel;
    ...
    #region 啟用/停用
    public async Task DisableIt(ProjectAdapterModel item)
    {
        await CurrentService.DisableIt(item);
        dataGrid.RefreshGrid();
    }
    public async Task EnableIt(ProjectAdapterModel item)
    {
