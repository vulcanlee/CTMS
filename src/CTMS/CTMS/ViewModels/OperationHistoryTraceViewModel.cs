...
public class OperationHistoryTraceViewModel
{
    #region Constructor
    ...
    public OperationHistoryTraceAdapterModel CurrentRecord { get; set; } = new OperationHistoryTraceAdapterModel();
    public OperationHistoryTraceAdapterModel CurrentNeedDeleteRecord { get; set; } = new OperationHistoryTraceAdapterModel();
    ...
    private readonly OperationHistoryTraceService CurrentService;
    ...
    public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
    {
        ...
        {
            CurrentRecord = new OperationHistoryTraceAdapterModel();
    ...
    public async Task OnCommandClicked(CommandClickEventArgs<OperationHistoryTraceAdapterModel> args)
    {
        OperationHistoryTraceAdapterModel item = args.RowData as OperationHistoryTraceAdapterModel;
